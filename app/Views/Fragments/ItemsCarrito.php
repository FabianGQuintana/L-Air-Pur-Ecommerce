    ...
    <div class="row g-0 align-items-center">
        ...
        <div class="col-md-6">
            <div class="card-body">
                ...
                <p class="card-text text-muted"><small>Stock disponible: <?= $item['stock'] ?></small></p>
            </div>
        </div>
        <div class="col-md-3 text-center">
            <div class="mb-2 d-flex justify-content-center align-items-center">
                ...
                <button class="btn btn-outline-secondary btn-sm ms-1 agregar-btn" data-id="<?= esc($item['id']) ?>" 
