...
<div class="container-fluid">
    <div class="row row-cols-1 row-cols-md-2 justify-content-center align-items-stretch m-3">
        ...
        <div class="col p-0">
            <div class="h-100">
                <iframe
                    ...
                    width="100%" height="100%" style="border:0;" allowfullscreen="" loading="lazy" class="w-100 h-100"
                    class="w-100 h-100 hover-effect">
                </iframe>
            </div>
        </div>
        ...
        <div class="seccionTexto col bg-light d-flex flex-column justify-content-center p-4">
            ...
            <p class="parrafoContactos"><strong>Email:</strong> l.air.purr@gmail.com</p>
