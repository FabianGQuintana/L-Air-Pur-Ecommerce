<link rel="stylesheet" href="assets/css/Style-Comercializacion.css">

<!-- ============================
    SECCIÓN: MÉTODOS DE PAGO
============================= -->
<div class="container-fluid">
    <div class="row row-cols-1 row-cols-md-2 justify-content-center align-items-stretch m-3">
        ...
        <div class="col p-0 d-flex align-items-center justify-content-center">
            <img src="assets/img/TarjetasAceptadas2.jpg" alt="Logos de tarjetas aceptadas"
                class="img-fluid w-100 h-100 object-fit-contain p-4 hover-effect">
        </div>
    ...
    <div class="row row-cols-1 row-cols-md-2 justify-content-center m-3">
        ...
        <div class="col mb-4 d-flex justify-content-center align-items-center">
            <div class="col-md-10 text-center">
                <img src="assets/img/TipoDeEntrega.png" alt="Tipo De Entregas"
                    class="img-fluid w-100 h-100 object-fit-contain p-4 hover-effect">
            </div>
        </div>
        <!-- Texto -->
...
<div class="container-fluid">
    <div class="row row-cols-1 row-cols-md-2 justify-content-center m-3">
        ...
        <div class="col mb-4 d-flex justify-content-center align-items-center">
            <div class="col-md-10 text-center">
                <img src="assets/img/CamionGrande.jpg" alt="Camión L’Air Pur"
                    class="img-fluid w-100 h-100 object-fit-contain p-4 hover-effect">
            </div>
        </div>
    </div>
